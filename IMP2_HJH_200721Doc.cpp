...
// IMP2_HJH_200721Doc.cpp: CIMP2HJH200721Doc 클래스의 구현
//
...
#include <propkey.h>
#include  "CStressTransformDlg.h" // 범위 강조 대화상자 사용을 위한 헤더 선언
...
IMPLEMENT_DYNCREATE(CIMP2HJH200721Doc, CDocument)

BEGIN_MESSAGE_MAP(CIMP2HJH200721Doc, CDocument)
	ON_COMMAND(IDD_DIALOG2, &CIMP2HJH200721Doc::OnUpSampling)
	ON_COMMAND(IDD_DIALOG3, &CIMP2HJH200721Doc::OnQuantization)
	ON_COMMAND(IDD_DIALOG4, &CIMP2HJH200721Doc::OnSumConstant)
	ON_COMMAND(IDD_DIALOG4, &CIMP2HJH200721Doc::OnSubConstant)
	ON_COMMAND(IDD_DIALOG4, &CIMP2HJH200721Doc::OnMulConstant)
	ON_COMMAND(IDD_DIALOG4, &CIMP2HJH200721Doc::OnDivConstant)
	ON_COMMAND(ID_AND_OPERATE, &CIMP2HJH200721Doc::OnAndOperate)
	ON_COMMAND(ID_OR_OPERATE, &CIMP2HJH200721Doc::OnOrOperate)
	ON_COMMAND(ID_XOR_OPERATE, &CIMP2HJH200721Doc::OnXorOperate)
	ON_COMMAND(ID_NEGA_TRANSFORM, &CIMP2HJH200721Doc::OnNegaTransform)
	ON_COMMAND(ID_GAMMA_CORRECTION, &CIMP2HJH200721Doc::OnGammaCorrection)
	ON_COMMAND(ID_BINARIZATION, &CIMP2HJH200721Doc::OnBinarization)
	ON_COMMAND(ID_STRESS_TRANSFORM, &CIMP2HJH200721Doc::OnStressTransform)
	ON_COMMAND(ID_HISTO_STRETCH, &CIMP2HJH200721Doc::OnHistoStretch)
	ON_COMMAND(ID_END_IN_SEARCH, &CIMP2HJH200721Doc::OnEndInSearch)
	ON_COMMAND(ID_HISTOGRAM, &CIMP2HJH200721Doc::OnHistogram)
	ON_COMMAND(ID_HISTO_EQUAL, &CIMP2HJH200721Doc::OnHistoEqual)
	ON_COMMAND(ID_HISTO_SPEC, &CIMP2HJH200721Doc::OnHistoSpec)
	ON_COMMAND(ID_EMBOSSING, &CIMP2HJH200721Doc::OnEmbossing)
	ON_COMMAND(ID_BLURR, &CIMP2HJH200721Doc::OnBlurr)
	ON_COMMAND(ID_GAUSSIAN_FILTER, &CIMP2HJH200721Doc::OnGaussianFilter)
	ON_COMMAND(ID_SHARPENING, &CIMP2HJH200721Doc::OnSharpening)
	ON_COMMAND(ID_HPF_SHARP, &CIMP2HJH200721Doc::OnHpfSharp)
	ON_COMMAND(ID_LPF_SHARP, &CIMP2HJH200721Doc::OnLpfSharp)
	ON_COMMAND(ID_DIFF_OPERATOR_HOR, &CIMP2HJH200721Doc::OnDiffOperatorHor)
	ON_COMMAND(ID_HOMOGEN_OPERATOR, &CIMP2HJH200721Doc::OnHomogenOperator)
	ON_COMMAND(ID_LAPLACIAN, &CIMP2HJH200721Doc::OnLaplacian)
	ON_COMMAND(ID_NEAREST, &CIMP2HJH200721Doc::OnNearest)
	ON_COMMAND(ID_BILINEAR, &CIMP2HJH200721Doc::OnBilinear)
	ON_COMMAND(ID_MEDIAN_SUB, &CIMP2HJH200721Doc::OnMedianSub)
	ON_COMMAND(ID_MEAN_SUB, &CIMP2HJH200721Doc::OnMeanSub)
	ON_COMMAND(ID_TRANSLATION, &CIMP2HJH200721Doc::OnTranslation)
	ON_COMMAND(ID_MIRROR_HOR, &CIMP2HJH200721Doc::OnMirrorHor)
	ON_COMMAND(ID_MIRROR_VER, &CIMP2HJH200721Doc::OnMirrorVer)
	ON_COMMAND(ID_ROTATION, &CIMP2HJH200721Doc::OnRotation)
	ON_COMMAND(ID_FRAME_SUM, &CIMP2HJH200721Doc::OnFrameSum)
	ON_COMMAND(ID_FRAME_SUB, &CIMP2HJH200721Doc::OnFrameSub)
	ON_COMMAND(ID_FRAME_MUL, &CIMP2HJH200721Doc::OnFrameMul)
	ON_COMMAND(ID_FRAME_DIV, &CIMP2HJH200721Doc::OnFrameDiv)
	ON_COMMAND(ID_FRAME_AND, &CIMP2HJH200721Doc::OnFrameAnd)
	ON_COMMAND(ID_FRAME_OR, &CIMP2HJH200721Doc::OnFrameOr)
	ON_COMMAND(ID_FRAME_COMB, &CIMP2HJH200721Doc::OnFrameComb)
	ON_COMMAND(ID_BINARY_EROSION, &CIMP2HJH200721Doc::OnBinaryErosion)
	ON_COMMAND(ID_BINARY_DILATION, &CIMP2HJH200721Doc::OnBinaryDilation)
	ON_COMMAND(ID_GRAY_EROSION, &CIMP2HJH200721Doc::OnGrayErosion)
	ON_COMMAND(ID_GRAY_DILATION, &CIMP2HJH200721Doc::OnGrayDilation)
	ON_COMMAND(ID_LOW_PASS_FILTER, &CIMP2HJH200721Doc::OnLowPassFilter)
	ON_COMMAND(ID_HIGH_PASS_FILTER, &CIMP2HJH200721Doc::OnHighPassFilter)
	ON_COMMAND(ID_MEAN_FILTER, &CIMP2HJH200721Doc::OnMeanFilter)
	ON_COMMAND(ID_MEDIAN_FILTER, &CIMP2HJH200721Doc::OnMedianFilter)
	ON_COMMAND(ID_MAX_FILTER, &CIMP2HJH200721Doc::OnMaxFilter)
	ON_COMMAND(ID_MIN_FILTER, &CIMP2HJH200721Doc::OnMinFilter)
	ON_COMMAND(ID_FFT_2D, &CIMP2HJH200721Doc::OnFft2d)
	ON_COMMAND(ID_IFFT_2D, &CIMP2HJH200721Doc::OnIfft2d)
	ON_COMMAND(ID_LPF_FREQUENCY, &CIMP2HJH200721Doc::OnLpfFrequency)
	ON_COMMAND(ID_HPF_FREQUENCY, &CIMP2HJH200721Doc::OnHpfFrequency)
END_MESSAGE_MAP()


// CIMP2HJH200721Doc 생성/소멸

CIMP2HJH200721Doc::CIMP2HJH200721Doc() noexcept
{
	// TODO: 여기에 일회성 생성 코드를 추가합니다.

}

CIMP2HJH200721Doc::~CIMP2HJH200721Doc()
{
}

BOOL CIMP2HJH200721Doc::OnNewDocument()
{
...
// CIMP2HJH200721Doc serialization

void CIMP2HJH200721Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CIMP2HJH200721Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CIMP2HJH200721Doc::InitializeSearchContent()
{
...
void CIMP2HJH200721Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CIMP2HJH200721Doc 진단

#ifdef _DEBUG
void CIMP2HJH200721Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CIMP2HJH200721Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CIMP2HJH200721Doc 명령


BOOL CIMP2HJH200721Doc::OnOpenDocument(LPCTSTR lpszPathName)
{
...
BOOL CIMP2HJH200721Doc::OnSaveDocument(LPCTSTR lpszPathName)
{
	...
	CFile File; // 파일 객체 선언
	CFileDialog SaveDlg(FALSE, L"raw", NULL, OFN_HIDEREADONLY); // raw 파일을 다른 이름으로 저장하기를 위한 대화상자 객체 선언

	if (SaveDlg.DoModal() == IDOK) { // DoModal 멤버 함수에서 저장하기 수행
...
void CIMP2HJH200721Doc::OnDownSampling()
{
	// TODO: 여기에 구현 코드 추가.
	int i, j;
	CDownSampleDlg dlg;
...
void CIMP2HJH200721Doc::OnUpSampling()
{
	...
	if (dlg.DoModal() == IDOK) { // DoModal 대화상자의 활성화 여부
		...
		for (i = 0; i < m_Re_size; i++) m_OutputImage[i] = 0; // 초기화
...
void CIMP2HJH200721Doc::OnQuantization()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnSumConstant()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnSubConstant()
{
...
void CIMP2HJH200721Doc::OnMulConstant()
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnDivConstant()
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnAndOperate()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnOrOperate()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnXorOperate()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnNegaTransform()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
	m_Re_height = m_height;
...
void CIMP2HJH200721Doc::OnGammaCorrection()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnBinarization()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CConstantDlg dlg;
	int i;
...
void CIMP2HJH200721Doc::OnStressTransform()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnHistoStretch()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
...
void CIMP2HJH200721Doc::OnEndInSearch()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i;
	unsigned char LOW, HIGH, MAX, MIN;
...
void CIMP2HJH200721Doc::OnHistogram()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	// 히스토그램의 값은 0~255
...
void CIMP2HJH200721Doc::OnHistoEqual()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, value;
...
void CIMP2HJH200721Doc::OnHistoSpec()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnEmbossing()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
double** CIMP2HJH200721Doc::OnMaskProcess(unsigned char* Target, double Mask[3][3])
{
	// TODO: 여기에 구현 코드 추가.
	// 회선 처리가 일어나는 함수
	int i, j, n, m;
...
double** CIMP2HJH200721Doc::OnScale(double** Target, int height, int width)
{
	// TODO: 여기에 구현 코드 추가.
	// 정규화를 위한 함수
	int i, j;
...
double** CIMP2HJH200721Doc::Image2DMem(int height, int width)
{
	// TODO: 여기에 구현 코드 추가.
	// 2차원 메모리 할당을 위한 함수
	double** temp;
...
void CIMP2HJH200721Doc::OnBlurr()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnGaussianFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnSharpening()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnHpfSharp()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnLpfSharp()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnDiffOperatorHor()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnHomogenOperator()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m;
...
double CIMP2HJH200721Doc::DoubleABS(double X)
{
	// TODO: 여기에 구현 코드 추가.
	// 실수의 절대 값 연산 함수
	if (X >= 0)
...
void CIMP2HJH200721Doc::OnLaplacian()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnNearest()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnBilinear()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnMedianSub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnBubleSort(double* A, int MAX)
{
	// TODO: 여기에 구현 코드 추가.
	// 데이터의 정렬을 처리하는 함수
	int i, j;
...
void CIMP2HJH200721Doc::OnSwap(double* a, double* b)
{
	// TODO: 여기에 구현 코드 추가.
	// 데이터 교환 함수
	double temp;
...
void CIMP2HJH200721Doc::OnMeanSub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnTranslation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnMirrorHor()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
	m_Re_height = m_height;
...
void CIMP2HJH200721Doc::OnMirrorVer()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
	m_Re_height = m_height;
...
void CIMP2HJH200721Doc::OnRotation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnFrameSum()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnFrameSub()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnFrameMul()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnFrameDiv()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnFrameAnd()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnFrameOr()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnFrameComb()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	CFile File;
	CFileDialog OpenDlg(TRUE);
...
void CIMP2HJH200721Doc::OnBinaryErosion()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m;
...
void CIMP2HJH200721Doc::OnBinaryDilation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m;
...
void CIMP2HJH200721Doc::OnGrayErosion()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m, h;
...
void CIMP2HJH200721Doc::OnGrayDilation()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m, h;
...
void CIMP2HJH200721Doc::OnLowPassFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnHighPassFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
...
void CIMP2HJH200721Doc::OnMeanFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m;
	m_Re_height = m_height;
	...
	m_Re_size = m_Re_height * m_Re_width;
	m_OutputImage = new unsigned char[m_Re_size];
	double** tempInputImage,
		** tempOutputImage, S = 0.0;
	tempInputImage = Image2DMem(m_height + 2, m_width + 2);
	tempOutputImage = Image2DMem(m_height, m_width);
	for (i = 0; i < m_height; i++) {
		for (j = 0; j < m_width; j++) {
...
void CIMP2HJH200721Doc::OnMedianFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m, index = 0;
...
void CIMP2HJH200721Doc::OnMaxFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m, index = 0;
	double** tempInputImage, Mask[9];
...
void CIMP2HJH200721Doc::OnMinFilter()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, n, m, index = 0;
	double** tempInputImage, Mask[9];
...
void CIMP2HJH200721Doc::OnFft2d()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
...
void CIMP2HJH200721Doc::OnFft1d(Complex* X, int N, int Log2N)
{
	// TODO: 여기에 구현 코드 추가.
	// 1차원 fft를 위한 함수
...
void CIMP2HJH200721Doc::OnShuffle(Complex* X, int N, int Log2N)
{
	// TODO: 여기에 구현 코드 추가.
...
void CIMP2HJH200721Doc::OnButterfly(Complex* X, int N, int Log2N, int mode)
{
	// TODO: 여기에 구현 코드 추가.
...
int CIMP2HJH200721Doc::OnReverseBitOrder(int index, int Log2N)
{
	// TODO: 여기에 구현 코드 추가.
	int i, X, Y;
	Y = 0;
...
void CIMP2HJH200721Doc::OnIfft2d()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, Num, Log2N;
	Complex* Data;
...
void CIMP2HJH200721Doc::OnIfft1d(Complex* X, int N, int Log2N)
{
	// TODO: 여기에 구현 코드 추가.
	OnShuffle(X, N, Log2N);
...
void CIMP2HJH200721Doc::OnLpfFrequency()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, x, y;
	double temp, D, N;
...
void CIMP2HJH200721Doc::OnHpfFrequency()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j, x, y;
	double temp, D, N;
